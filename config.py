...
DOWNLOAD_TIMEOUT = int(os.environ.get("MAGNETO_DOWNLOAD_TIMEOUT", 20 * 60))
...
PLAYLIST_MAX = int(os.environ.get("MAGNETO_PLAYLIST_MAX", 50))
...
FEED_VIDEOS_MAX = int(os.environ.get("MAGNETO_FEED_VIDEOS", 5))
...
FEED_POLL = int(os.environ.get("MAGNETO_FEED_POLL", 300))
...
POLL = {
    "youtube": FEED_POLL,
    "tiktok": int(os.environ.get("MAGNETO_TIKTOK_POLL", FEED_POLL)),
}


FEED_TTL = int(os.environ.get("MAGNETO_FEED_TTL", 6 * 3600))


FEED_COOLDOWN = int(os.environ.get("MAGNETO_FEED_COOLDOWN", 600))
...
CHANNELS_MAX = {
    "youtube": int(os.environ.get("MAGNETO_FEED_CHANNELS_MAX", 30)),
    "tiktok": int(os.environ.get("MAGNETO_TIKTOK_ACCOUNTS_MAX", 30)),
}
...
# to show without it.
SHORTS_ENABLED = FEED_ENABLED and enabled("MAGNETO_SHORTS")
...
SHORTS_RETENTION = int(os.environ.get("MAGNETO_SHORTS_RETENTION", 24 * 3600))
...
SEEN_RETENTION = int(os.environ.get("MAGNETO_SEEN_RETENTION", 7 * 24 * 3600))
...
TIKTOK_ENABLED = enabled("MAGNETO_TIKTOK")
...
SHARE_ENABLED = enabled("MAGNETO_SHARE")


SHARE_TTL = int(os.environ.get("MAGNETO_SHARE_TTL", 48 * 3600))


SHARE_MAX = int(os.environ.get("MAGNETO_SHARE_MAX", 10))
...
PIN_RETENTION = int(os.environ.get("MAGNETO_PIN_RETENTION", 30 * 24 * 3600))


HISTORY_MAX = int(os.environ.get("MAGNETO_HISTORY_MAX", 200))
...
AUTH_MODE = os.environ.get("MAGNETO_AUTH", "none")


ADMIN_GROUP = os.environ.get("MAGNETO_ADMIN_GROUP", "admin")


# The session belongs to the proxy, so signing out is a link to it, not
# something this app can do. Empty means no button.
LOGOUT_URL = os.environ.get("MAGNETO_LOGOUT_URL", "")
